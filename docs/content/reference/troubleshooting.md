...
Most of these come down to network reality or how ipinfo serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

ipinfo rate-limits like any public site. ipinfo already paces
...
Where a surface is gated, ipinfo reads a cookie or token you supply
...
`ipinfo`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what ipinfo actually did
