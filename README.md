...
Or grab a prebuilt binary from the [releases](https://github.com/tamnd/ipinfo-cli/releases), or run
the container image:
...
ipinfo --help                           # the whole command tree
```
...
ipinfo mcp                   # speak MCP over stdio
```

## Use it as a resource-URI driver

`ipinfo` registers a `ipinfo` domain the way a program registers a
...
```
cmd/ipinfo/   thin main: hands cli.NewApp to kit.Run
