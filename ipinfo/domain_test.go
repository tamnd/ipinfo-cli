...
// HTTP behaviour is covered in ipinfo_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "ipinfo://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("ipinfo", "about")
	if err != nil || got.String() != "ipinfo://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want ipinfo://page/about", got.String(), err)
	}
}
